...
void Exercise01() {
    ...
    measureTime(selectionSort<int>, originalList, "Selection Sort", size);
    measureTime(bubbleSort<int>, originalList, "Bubble Sort", size);
    //measureTime(insertionSort<int>, originalList, "Insertion Sort", size);
...
void Exercise07() {
    ...
    for (int size : sizes) {
        ...
        measureTime2(hybridSort<int>, hybridSortList, "Hybrid Sort");
    }
}
...
void Exercise08() {
    ...
    for (int size : sizes) {
        ...
        measureTime(quickSort<int>, quickSortList, "Quick Sort");

        vector<int> hybridSortList = originalList; // Copy for Hybrid Sort
        measureTime(hybridSort<int>, hybridSortList, "Hybrid Sort");
    }
}
